 ...
 * in the parent; the open/collapsed toggle is `CollapsibleSection`'s own,
 * seeded from `initialOpen`.
 */
export function VariantsEditor({
  ...
  return (
    <CollapsibleSection title={t(`${ns}.variantsToggle`)} defaultOpen={initialOpen}>
