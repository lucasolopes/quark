...
describe("LinkStats", () => {
  ...
  it("shows the total clicks", async () => {
    vi.spyOn(globalThis, "fetch").mockResolvedValue(new Response(JSON.stringify({
      aggregates: { total: 42, first_ts: 1700000000, last_ts: 1700100000, per_day: { "2024-01-01": 42 }, per_country: { BR: 40, US: 2 }, per_device: { Mobile: 30, Desktop: 12 }, per_variant: {} },
      recent: [],
    }), { status: 200 }));
    render(wrap("6lB362J"));
  ...
  it("empty state when total is 0", async () => {
    vi.spyOn(globalThis, "fetch").mockResolvedValue(new Response(JSON.stringify({
      aggregates: { total: 0, first_ts: 0, last_ts: 0, per_day: {}, per_country: {}, per_device: {}, per_variant: {} },
      recent: [],
    }), { status: 200 }));
    render(wrap("6lB362J"));
