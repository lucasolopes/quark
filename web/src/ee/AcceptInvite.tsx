...
import { OutOfShellBackdrop, OutOfShellFrame } from "@/components/OutOfShellFrame";
...
export function AcceptInvite() {
  ...
  if (me.isLoading) {
    // No title/card at this point — just the spinner on the shared backdrop —
    // so this uses the bare `OutOfShellBackdrop` rather than `OutOfShellFrame`
  ...
  if (!me.data?.authenticated) {
    return (
      <OutOfShellFrame title={t("accept.title")}>
