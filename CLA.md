...
- **"You"** (or "Your") means the copyright owner, or the legal entity authorized
  by the copyright owner, entering into this Agreement.
...
in this Agreement transfers ownership of Your Contributions to the Maintainer,
and You remain free to use Your Contributions for any other purpose. This
Agreement grants only the licenses described below.
...
This license expressly includes the Maintainer's right to **license and
relicense Your Contributions under any terms**, including both open-source
licenses (such as the GNU Affero General Public License v3.0) and proprietary or
commercial licenses, and to include them in a hosted or commercial edition of
quark, at the Maintainer's discretion.
...
any other entity (including a cross-claim or counterclaim in a lawsuit) alleging
that Your Contribution, or the project to which You contributed, constitutes
direct or contributory patent infringement, then any patent licenses granted to
that entity under this Agreement for that Contribution or project shall terminate
...
3. To the best of Your knowledge, Your Contributions do not violate any third
...
extent You desire to. Your Contributions are provided "AS IS", without warranties
of any kind, express or implied. The Maintainer is under no obligation to accept
or include any Contribution.
...
source and of any license or other restriction of which You are personally aware,
and conspicuously marking the work as "Submitted on behalf of a third party:
[named here]".

## 8. Notice of inaccuracy
...
Contributions to quark are gated by an automated CLA check. When You open your
first pull request, a bot will ask You to accept this Agreement by commenting on
or confirming the PR. **You sign once per GitHub account**, and the signature
applies to all of Your future Contributions to quark.
