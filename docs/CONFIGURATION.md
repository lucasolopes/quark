...
| `QUARK_HEALTH_CHECK_SECS` | unset (disabled) | Enables broken-link monitoring: seconds between destination-health sweeps (clamped up to 60). Only the designated node (`QUARK_NODE_ID` 0/unset) sweeps. See [LINK-HEALTH](LINK-HEALTH.md). |
